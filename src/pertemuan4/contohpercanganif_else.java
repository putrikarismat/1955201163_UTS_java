 ...
 * @author LENOVO
 */
public class contohpercanganif_else {
    public static void main(String[] args) {
      ...
      if(hargacat >=100){
        JOptionPane.showMessageDialog(null, "selamat anda mendapatkan cat yang bagus");
      
        
       }else {
          JOptionPane.showMessageDialog(null, "maaf cat yang anda beli belum tersedia");
